 ...
 * [CoordinatorFragment.OnListFragmentInteractionListener] interface.
 */
class CoordinatorFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_coordinator_list, container, false)
        ...
        if (recyclerView is RecyclerView) {
            with(recyclerView) {
                ...
                adapter = CoordinatorRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
